...
hyp = {'giou': 3.54,  # giou loss gain
       ...
       'lrf': 0.000001,  # final LambdaLR learning rate = lr0 * (10 ** lrf)
...
def train():
    ...
    init_seeds(seed_num)
    if opt.multi_scale:
        img_sz_min = round(img_size / 32 / 1.50)
        img_sz_max = round(img_size / 32 * 1.50)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/new_coco/Grayscale_Single_Channel_YOLOv3_SPP_April.pt', help='initial weights')
